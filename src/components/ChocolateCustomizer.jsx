  ...
  return (
    <section id="chocolate-customizer" className="chocolate-customizer-section">
      <div className="container">
        ...
        <div className="section-header">
          ...
          <p className="section-description">
            Select your favorite chocolate flavors, crispy add-ons, shapes, luxury packaging, ribbon colors, and personalized notes for a memorable gift.
          </p>
        </div>
      ...
      <style>{`
        ...
        /* 1:1 Square Image Container with Pure White Background & 16px Padding */
        .flavor-img-wrap {
          position: relative;
          width: 100%;
          aspect-ratio: 1 / 1;
